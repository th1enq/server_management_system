...
type UserUpdate struct {
	...
	Role      domain.UserRole   `json:"role" binding:"oneof=user admin"`
	FirstName string            `json:"first_name"`
	LastName  string            `json:"last_name"`
	IsActive  bool              `json:"is_active" binding:"omitempty"`
	Scopes    []domain.APIScope `json:"scopes" binding:"omitempty"`
}
...
type CreateUserRequest struct {
	...
	Role      domain.UserRole   `json:"role" binding:"oneof=user admin" default:"user"`
	Scopes    []domain.APIScope `json:"scopes" binding:"omitempty"`
}
