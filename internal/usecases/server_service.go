...
func NewServerUsecase(repo repository.IServerRepository, cache db.IRedisClient, logger *zap.Logger) ServerUsecase {
...
func (s *serverUsecase) CreateServer(ctx context.Context, server *models.Server) error {
...
func (s *serverUsecase) GetServer(ctx context.Context, id uint) (*models.Server, error) {
...
func (s *serverUsecase) GetAllServers(ctx context.Context) ([]models.Server, error) {
	cacheKey := "server:all"
...
func (s *serverUsecase) UpdateServer(ctx context.Context, id uint, updates dto.ServerUpdate) (*models.Server, error) {
	server, err := s.repo.GetByID(ctx, id)
	if err != nil {
...
func (s *serverUsecase) UpdateServerStatus(ctx context.Context, serverID string, status models.ServerStatus) error {
...
func (s *serverUsecase) CheckServer(ctx context.Context, server models.Server) error {
...
func (s *serverUsecase) ClearServerCaches(ctx context.Context, server *models.Server) error {
