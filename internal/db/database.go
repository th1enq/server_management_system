...
type IDatabaseClient interface {
	WithContext(ctx context.Context) IDatabaseClient
	Where(query interface{}, args ...interface{}) IDatabaseClient
	Limit(limit int) IDatabaseClient
	Offset(offset int) IDatabaseClient
	Model(value interface{}) IDatabaseClient
	Order(value interface{}) IDatabaseClient
...
func (p *gormDatabase) Limit(limit int) IDatabaseClient {
	return &gormDatabase{
		client: p.client.Limit(limit),
	}
}

func (p *gormDatabase) Model(value interface{}) IDatabaseClient {
	return &gormDatabase{
		client: p.client.Model(value),
	}
}

func (p *gormDatabase) Offset(offset int) IDatabaseClient {
	return &gormDatabase{
		client: p.client.Offset(offset),
	}
}

func (p *gormDatabase) Order(value interface{}) IDatabaseClient {
	return &gormDatabase{
...
func (p *gormDatabase) Where(query interface{}, args ...interface{}) IDatabaseClient {
	return &gormDatabase{
		client: p.client.Where(query, args...),
	}
}

func (p *gormDatabase) WithContext(ctx context.Context) IDatabaseClient {
	return &gormDatabase{
...
func NewDatabase(cfg configs.Database, logger *zap.Logger) (IDatabaseClient, error) {
...
func NewDatabaseWithGorm(gormDB *gorm.DB) IDatabaseClient {
	if gormDB == nil {
		return nil
	}
